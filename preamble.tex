...
\candidate{Firstname Lastname} % your name (without title)
...
\majoradvisor{Advisor Name} % name of supervisor (without title)
...
\candidatenumber{ Student ID}
%\major{} % major (not necessary if same as subject)
\keywords{KEYWORD ONE / KEYWORD TWO / KEYWORD THREE}
\keywordsII{KEYWORD FOUR / KEYWORD FIVE}
%\keywordsIII{}
